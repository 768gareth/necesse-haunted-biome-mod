...
public class RegisterObjects 
{
    public static void Register()
    {
        ...
        ObjectRegistry.registerObject("void_candle", (new TorchObject("void_candle", ToolType.ALL, new Color(255, 255, 152), 275.0F, 0.2F, true, 4)).setWallPlaceObjectStringID("wall_void_candle"), 5.0F, true);
        ObjectRegistry.registerObject("wall_void_candle", (new WallCandleObject()).setItemDroppedStringID("void_candle"), 5.0F, false);
