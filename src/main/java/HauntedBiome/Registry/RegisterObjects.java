...
public class RegisterObjects 
{
    public static void Register()
    {
        ...
        ObjectRegistry.registerObject("void_fragment_cluster_small", new CrystalClusterSmallObject("void_fragment_cluster_small", new Color(97, 31, 127), 240.0F, "void_fragment", 0, 1, 1, crystalsCategory), 5f, true);
        CrystalClusterObject.registerCrystalCluster("void_fragment_cluster_large", new Color(97, 31, 127), 247.0F, "void_fragment", 10.0F, true, crystalsCategory);

        RockObject VoidRock;
        RockObject DeepVoidRock;
        ObjectRegistry.registerObject("void_rock", VoidRock = new RockObject("void_rock", new Color(50, 50, 150), "void_stone", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("deep_void_rock", DeepVoidRock = new RockObject("deep_void_rock", new Color(50, 50, 150), "void_stone", genericRocksCategory), 2.0F, true);
        
        ObjectRegistry.registerObject("void_rock_small", new SingleRockSmall(VoidRock, "void_rock_small", new Color(70, 70, 152), genericRocksCategory), 2.0F, true);
        SingleRockObject.registerSurfaceRock(VoidRock, "void_rock_large", new Color(49, 142, 184), 2.0F, true, genericRocksCategory);

        ObjectRegistry.registerObject("iron_ore_void_rock", new RockOreObject(VoidRock, "oremask", "ironore", new Color(169, 128, 106), "ironore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("copper_ore_void_rock", new RockOreObject(VoidRock, "oremask", "copperore", new Color(161, 83, 42), "copperore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("gold_ore_void_rock", new RockOreObject(VoidRock, "oremask", "goldore", new Color(198, 145, 47), "goldore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("demonic_ore_void_rock", new RockOreObject(VoidRock, "oremask", "demonic_ore", new Color(88, 0, 108), "demonic_ore", genericRocksCategory), 2.0F, true);
       
        ObjectRegistry.registerObject("iron_ore_deep_void_rock", new RockOreObject(DeepVoidRock, "oremask", "ironore", new Color(169, 128, 106), "ironore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("copper_ore_deep_void_rock", new RockOreObject(DeepVoidRock, "oremask", "copperore", new Color(161, 83, 42), "copperore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("gold_ore_deep_void_rock", new RockOreObject(DeepVoidRock, "oremask", "goldore", new Color(198, 145, 47), "goldore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("tungsten_ore_deep_void_rock", new RockOreObject(DeepVoidRock, "oremask", "tungstenore", new Color(40, 49, 57), "tungstenore", genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("life_quartz_deep_void_rock", new RockOreObject(DeepVoidRock, "oremask", "lifequartzore", new Color(180, 50, 61), "lifequartz", 1, 1, 1, genericRocksCategory), 2.0F, true);
        ObjectRegistry.registerObject("demonic_ore_deep_void_rock", new RockOreObject(DeepVoidRock, "oremask", "demonic_ore", new Color(88, 0, 108), "demonic_ore", genericRocksCategory), 2.0F, true);
    }
}
