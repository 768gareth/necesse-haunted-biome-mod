...
{
    public static ChestRoomSet HauntedBiomeSet = new ChestRoomSet("void_stone_floor", "dungeonpressureplate", RegisterWallSets.VoidWall, ColumnSet.obsidian, "demonchest", new String[]{"void_wall_flame_trap",});
