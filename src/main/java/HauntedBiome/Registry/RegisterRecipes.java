...
public class RegisterRecipes 
{
    public static void Register()
    {
        ...
        Recipes.registerModRecipe(new Recipe("voidshard", 1, RecipeTechRegistry.FORGE, new Ingredient[] { new Ingredient("void_fragment", 3)}));
        ...
        Recipes.registerModRecipe(new Recipe("void_chalice", 1, RecipeTechRegistry.DEMONIC_WORKSTATION, new Ingredient[] { new Ingredient("void_stone", 4)}));

        Recipes.registerModRecipe(new Recipe("void_wall_flame_trap", 1, RecipeTechRegistry.DEMONIC_WORKSTATION, new Ingredient[] { new Ingredient("void_stone", 4), new Ingredient("firemone", 5), new Ingredient("wire", 5)}));
        ...
        Recipes.registerModRecipe(new Recipe("void_fragment_cluster", 1, RecipeTechRegistry.LANDSCAPING, new Ingredient[] { new Ingredient("void_fragment", 2)}));
