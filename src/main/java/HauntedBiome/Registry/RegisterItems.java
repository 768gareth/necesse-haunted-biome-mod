...
public class RegisterItems 
{
    public static void Register()
    {
        ...
        ItemRegistry.registerItem("bloodberry", (new FoodConsumableItem(250, Rarity.NORMAL, Settler.FOOD_SIMPLE, 10, 240, new ModifierValue[]{new ModifierValue(BuffModifiers.MAX_MANA_FLAT, 10)})).spoilDuration(480).addGlobalIngredient(new String[]{"anycompostable", "anyfruit"}).setItemCategory(new String[]{"consumable", "rawfood"}), 4.0F, true);
