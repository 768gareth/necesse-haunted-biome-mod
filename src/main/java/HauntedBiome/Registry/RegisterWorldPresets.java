...
public class RegisterWorldPresets 
{
    public static void Register()
    {
        ...
        WorldPresetRegistry.registerPreset("void_crystal_clusters_deep_caves", new CustomCrystalsWorldPreset(BiomeRegistry.getBiome("haunted_biome"), LevelIdentifier.DEEP_CAVE_IDENTIFIER, 0.01F, "void_gravel_tile", "void_crystal_cluster_small", "void_crystal_cluster_large"));
