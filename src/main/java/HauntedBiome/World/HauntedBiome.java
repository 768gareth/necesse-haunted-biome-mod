...
public class HauntedBiome extends Biome 
{
    ...
    public static MobSpawnTable DeepCaveCritters = new MobSpawnTable().include(Biome.defaultCaveCritters).add(50, "void_caveling");

    public static WallSet VoidWall = new WallSet("void_");
    public static ChestRoomSet HauntedBiomeSet = new ChestRoomSet("void_stone_floor", "dungeonpressureplate", WallSet.dungeon, ColumnSet.obsidian, "storagebox", new String[]{"void_wall_arrow_trap", "void_wall_void_trap"});
    ...
    public void generateRegionSurfaceTerrain(Region region, BiomeGeneratorStack stack, GameRandom random) 
    {
        ...
        stack.startPlaceOnVein(this, region, random, "hauntedBlackberries").onlyOnTile(GrassTile).placeObjectFruitGrower("blackberrybush");
    ...
    public void generateRegionCaveTerrain(Region region, BiomeGeneratorStack stack, GameRandom random) {
        ...
        stack.startPlaceOnVein(this, region, random, "hauntedCopper").onlyOnObject(RockID).placeObjectForced("copper_ore_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedIron").onlyOnObject(RockID).placeObjectForced("iron_ore_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedGold").onlyOnObject(RockID).placeObjectForced("gold_ore_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedDemonic").onlyOnObject(RockID).placeObjectForced("demonic_ore_void_rock");
        stack.startPlace(this, region, random).chance(0.004).placeObject("void_rock_small");
        stack.startPlace(this, region, random).chance(0.002).placeObject("void_rock_large");
        region.updateLiquidManager();
    }
    ...
    public void generateRegionDeepCaveTerrain(Region region, BiomeGeneratorStack stack, GameRandom random) {
        ...
        stack.startPlaceOnVein(this, region, random, "hauntedDeepCopper").onlyOnObject(RockID).placeObjectForced("copper_ore_deep_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedDeepIron").onlyOnObject(RockID).placeObjectForced("iron_ore_deep_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedDeepGold").onlyOnObject(RockID).placeObjectForced("gold_ore_deep_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedDeepObsidian").onlyOnObject(RockID).placeObjectForced("obsidianrock");
        stack.startPlaceOnVein(this, region, random, "hauntedDeepTungsten").onlyOnObject(RockID).placeObjectForced("tungsten_ore_deep_void_rock");
        stack.startPlaceOnVein(this, region, random, "hauntedDeepLifeQuartz").onlyOnObject(RockID).placeObjectForced("life_quartz_deep_void_rock");
        stack.startPlace(this, region, random).chance(0.004).placeObject("void_rock_small");
    ...
    {
        RandomCaveChestRoom chestRoom = new RandomCaveChestRoom(random, HauntedLootTables.HauntedCavesChest, lootRotation, HauntedBiomeSet);
        return chestRoom;
    }
    ...
    {
        RandomCaveChestRoom chestRoom = new RandomCaveChestRoom(random, HauntedLootTables.DeepHauntedCavesChest, lootRotation, HauntedBiomeSet);
        return chestRoom;
    }
    ...
    {
        WallSet wallSet = WallSet.dungeon;
        FurnitureSet furnitureSet = FurnitureSet.dungeon;
        String floorStringID = "dungeonfloor";
        return ((CaveRuins.CaveRuinGetter)random.getOneOf(CaveRuins.caveRuinGetters))
        .get(random, wallSet, furnitureSet, floorStringID, LootTablePresets.plainsCaveRuinsChest, lootRotation);
    }
    ...
    public CaveRuins getNewDeepCaveRuinsPreset(GameRandom random, AtomicInteger lootRotation) 
    {
        ...
        String floorStringID = "dungeonfloor";
        return ((CaveRuins.CaveRuinGetter)random.getOneOf(CaveRuins.caveRuinGetters))
        .get(random, wallSet, furnitureSet, floorStringID, LootTablePresets.plainsDeepCaveRuinsChest, lootRotation);
    }
}