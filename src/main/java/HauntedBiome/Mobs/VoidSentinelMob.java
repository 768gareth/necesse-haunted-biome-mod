...
// TODO: A powerful but slow moving melee mob that spawns in the deep caves. Wears a special suit of armour.
public class VoidSentinelMob extends HostileItemAttackerMob
{
    ...
    public VoidSentinelMob()
    {
        ...
        this.helmet = null;
        this.chest = new InventoryItem("void_sentinel_chest");
    ...
    {
        List<InventoryItem> availableArmour = new ArrayList<>();
        availableArmour.add(helmet);
        availableArmour.add(chest);
        availableArmour.add(boots);
        InventoryItem armourDrop = (InventoryItem) GameRandom.globalRandom.getOneOf(availableArmour);
        return new LootTable(new LootItemInterface[]{ new ChanceLootItem(0.05f, armourDrop.getGndData().getStringID())});
    }
