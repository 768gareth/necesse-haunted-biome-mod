...
public class VoidGatewayMinionMob extends HostileItemAttackerMob
{
    public InventoryItem helmet;
    public InventoryItem chest;
    public InventoryItem boots;
    public InventoryItem weapon;
    public VoidGatewayMob master;

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public VoidGatewayMinionMob()
    {
        super(150);
        this.setArmor(5);
        this.setSpeed(25F);
        ...
        this.weapon = new InventoryItem("demonicsword");
        this.helmet = null;
    ...
    public VoidGatewayMinionMob(VoidGatewayMob masterMob)
    {
        this();
        this.master = masterMob;
    }

    public LootTable getLootTable() 
    {
      return new LootTable(new LootItemInterface[]{ new ChanceLootItem(0.05f, weapon.getGndData().getStringID()), new ChanceLootItem(0.2f, "healthpotion", GameRandom.globalRandom.getIntBetween(1, 2))});
    }
    ...
    protected void onDeath(Attacker attacker, HashSet<Attacker> attackers)
    {
        ...
        this.master.spawnedMobCount = this.master.spawnedMobCount - 1;
    }
