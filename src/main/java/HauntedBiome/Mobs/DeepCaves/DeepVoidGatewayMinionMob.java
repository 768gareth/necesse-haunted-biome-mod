...
public class DeepVoidGatewayMinionMob extends HostileItemAttackerMob
{
    public InventoryItem helmet;
    public InventoryItem chest;
    public InventoryItem boots;
    public InventoryItem weapon;
    public DeepVoidGatewayMob master;

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public DeepVoidGatewayMinionMob()
    {
        super(400);
        this.setArmor(15);
        this.setSpeed(30F);
    ...
    public DeepVoidGatewayMinionMob(DeepVoidGatewayMob masterMob)
    {
        this();
