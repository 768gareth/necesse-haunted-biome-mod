...
public class ZombieWarriorMob extends HostileItemAttackerMob
{
    ...
    public ZombieWarriorMob()
    {
        ...
        this.weapon = GameRandom.globalRandom.getOneOf(new InventoryItem("ironsword"), new InventoryItem("ironspear"));
        this.helmet = null;
